...
class Config:
    ...
    def __init__(self, seed: int = 123):
        ...
        self.OUTPUT_DIR = "__5__nca_outputs_with_walls"  # Nouveau répertoire pour les résultats avec obstacles
...
cfg.OUTPUT_DIR = f"__5__nca_outputs_with_walls_seed_{cfg.SEED}"
